...
```javascript
FLOAT32_MAX_SAFE_NTH_FIBONACCI = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-max-safe-nth-fibonacci@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-max-safe-nth-fibonacci/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/constants-float32-max-safe-nth-fibonacci/actions/workflows/test.yml?query=branch:v0.1.1
